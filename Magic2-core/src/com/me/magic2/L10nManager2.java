...
public class L10nManager2 {
	
	public L10nManager2(String...langs){
		...
		for(String lang : langs){
			...
			try{ 
				...
				Gdx.app.error(L10nManager2.this.getClass().getName(), "error reading file" ,ex);
			}
			finally{
				if(br!=null){
					try {
						...
						Gdx.app.error(L10nManager2.this.getClass().getName(), "error closing stream" ,e);
